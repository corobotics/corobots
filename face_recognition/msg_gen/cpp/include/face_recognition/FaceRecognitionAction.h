/* Auto-generated by genmsg_cpp for file /home/spyder/corobot_ws/src/corobots/face_recognition/msg/FaceRecognitionAction.msg */
...
struct FaceRecognitionAction_ {
  ...
  typedef  ::face_recognition::FaceRecognitionActionGoal_<ContainerAllocator>  _action_goal_type;
   ::face_recognition::FaceRecognitionActionGoal_<ContainerAllocator>  action_goal;

  typedef  ::face_recognition::FaceRecognitionActionResult_<ContainerAllocator>  _action_result_type;
   ::face_recognition::FaceRecognitionActionResult_<ContainerAllocator>  action_result;

  typedef  ::face_recognition::FaceRecognitionActionFeedback_<ContainerAllocator>  _action_feedback_type;
   ::face_recognition::FaceRecognitionActionFeedback_<ContainerAllocator>  action_feedback;
...
{
template<class ContainerAllocator> struct IsMessage< ::face_recognition::FaceRecognitionAction_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::face_recognition::FaceRecognitionAction_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
