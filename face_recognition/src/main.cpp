...
#include "../../corobot_common/srv_gen/cpp/include/corobot_common/WebcamService.h" // The WebcamService for ROS
...
Ptr<FaceRecognizer> model; //SAVING
...
bool callback(corobot_common::WebcamService::Request  &req, corobot_common::WebcamService::Response &res)
{
...
int main(int argc, char *argv[])
{
	...
	//Start the WebcamService service
	ros::init(argc, argv, "WebcamService");
	ros::NodeHandle n;
	ros::ServiceServer service = n.advertiseService("WebcamService", callback);
